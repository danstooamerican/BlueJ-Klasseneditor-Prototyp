...
public class ClassdiagramPackageImpl extends EPackageImpl implements ClassdiagramPackage {
	 ...
	 * @generated
	 */
	public EAttribute getClassModel_Name() {
		return (EAttribute)classModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClassModel_AbstractClass() {
		return (EAttribute)classModelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getClassModel_Extends() {
		return (EReference)classModelEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(classModelEClass, CLASS_MODEL__NAME);
		createEAttribute(classModelEClass, CLASS_MODEL__ABSTRACT_CLASS);
		createEReference(classModelEClass, CLASS_MODEL__EXTENDS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getClassModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, ClassModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClassModel_AbstractClass(), ecorePackage.getEBoolean(), "abstractClass", null, 0, 1, ClassModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClassModel_Extends(), this.getClassModel(), null, "extends", null, 0, 1, ClassModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classDiagramEClass, ClassDiagram.class, "ClassDiagram", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClassDiagram_Classes(), this.getClassModel(), null, "classes", null, 0, -1, ClassDiagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
