...
public class ClassDiagramImpl extends MinimalEObjectImpl.Container implements ClassDiagram {
	 ...
	 * @ordered
	 */
	protected EList<ClassModel> classes;
	 ...
	 * @generated
	 */
	public EList<ClassModel> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList<ClassModel>(ClassModel.class, this, ClassdiagramPackage.CLASS_DIAGRAM__CLASSES);
		}
		return classes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ClassdiagramPackage.CLASS_DIAGRAM__CLASSES:
				getClasses().clear();
				getClasses().addAll((Collection<? extends ClassModel>)newValue);
				return;
		}
